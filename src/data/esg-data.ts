export const ESG_STATS = [
  ...
  },
  {
    ...
    value: "94%",
    sub: "Zambian employees across all active sites",
  },
  {
    label: "Safety Record",
    value: "1.2M+",
    sub: "Man-hours without a lost-time injury",
  },
];
...
export const PRINCIPLES = [
  ...
  },
  {
    id: "social",
    title: "Social",
    subtitle: "People at the core",
    desc: "Our workforce is our greatest asset. We invest in local education, vocational training, and community healthcare. The Ubuntu Mentorship Program ensures that skills stay within Zambia, creating a lasting legacy of technical excellence that outlives any single project.",
    metric: "1,500+ Local Jobs Created",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/dxhwcq1eg/image/upload/f_auto,q_auto/skt_global_mining/operational-command-new.webp",
