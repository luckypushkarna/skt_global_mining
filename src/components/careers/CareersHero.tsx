    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-neutral-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full text-center">
        ...
        >
          ...
          <br className="hidden md:block" /> the mining industry.
        </motion.h1>
        ...
        >
          Join a team powering world-class copper operations. We invest in our people, develop their skills, and create long-term career pathways across our integrated mining ecosystem.
        </motion.p>
      </div>
