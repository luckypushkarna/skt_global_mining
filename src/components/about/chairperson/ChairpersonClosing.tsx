...
export default function ChairpersonClosing() {
  return (
    <section className="py-24 md:py-40 bg-neutral-950 border-t border-white/5 relative overflow-hidden">
      {/* Subtle background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-skt-blue/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xs tracking-[0.1em] uppercase text-white/30">
