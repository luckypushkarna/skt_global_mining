...
export default function ChairpersonHero() {
  return (
    <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-bg-soft pt-24 pb-16 md:pt-32 md:pb-24 border-b border-slate-200">
      ...
      >
        ...
        <div className="w-12 h-[1px] bg-slate-200 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-1/2 h-full bg-skt-blue animate-scroll-line-horizontal" />
        </div>
      </motion.div>
    </section>
  );
