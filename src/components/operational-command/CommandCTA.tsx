    ...
    <section className="bg-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-5 lg:px-12 py-16 lg:py-24">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 py-8 border-y border-white/10">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-slate-900 border border-emerald-500/10 text-emerald-50 text-sm font-semibold hover:bg-slate-800 transition-colors group whitespace-nowrap flex-shrink-0"
          >
            {cta.button}
            <ArrowRight
