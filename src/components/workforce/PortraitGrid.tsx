...
const TEAM_MEMBERS: TeamMember[] = [
  { num: "01/08", name: "Mulenga Mutati", role: "Chief of Zambia Operations", exp: "14 Years at SKT", image: "/Mulenga Mutati.webp" },
  { num: "02/08", name: "Charles Sakanya", role: "Senior Metallurgical Director", exp: "9 Years at SKT", image: "/Charles Sakanya.webp" },
  { num: "03/08", name: "Safeli Maxim Chipulu", role: "Underground Shift Manager", exp: "11 Years at SKT", image: "/Safeli maxim chipulu.webp" },
  { num: "04/08", name: "Toms Joseph", role: "Logistics Division Lead", exp: "7 Years at SKT", image: "/Toms Joseph.webp" },
  { num: "05/08", name: "Anand Kolappa Pillai", role: "Refining Systems Specialist", exp: "8 Years at SKT", image: "/Anand Kolappa Pillai.webp" },
  { num: "06/08", name: "Kiran Kumar Reddy", role: "Heavy Maintenance Superintendent", exp: "10 Years at SKT", image: "/Kiran Kumar Reddy.webp" },
  { num: "07/08", name: "Sahil Talreja", role: "Civil & Infrastructure Engineer", exp: "6 Years at SKT", image: "/Sahil Talreja.webp" },
  { num: "08/08", name: "Sanjay Kumar Sharma", role: "Power Systems Engineer", exp: "12 Years at SKT", image: "/Sanjay Kumar sharma.webp" },
];
