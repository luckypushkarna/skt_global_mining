...
export function WorkshopMaintenance() {
  const { maintenance } = UNDERGROUND_WORKSHOP;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-16 lg:mb-20 items-start">
          ...
          <div className="lg:col-span-5 relative aspect-[4/5] bg-slate-100 overflow-hidden">
            <Image
              ...
              alt="Underground Workshop maintenance workshop - SKT Global technicians performing planned maintenance"
              fill
          ...
          <div className="lg:col-span-7 lg:pt-4">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 leading-[1.08] mb-6">
              {maintenance.title}
            </h2>
