  ...
  return (
    <div className="stone-marker-gsap w-12 h-12 flex items-center justify-center select-none" data-index={index} style={{ willChange: "transform, opacity" }}>
      ...
      <div className="relative w-11 h-11">
        <Image
          src="https://res.cloudinary.com/dxhwcq1eg/image/upload/v1782125522/skt_global_mining/stone-marker-v2.webp"
          alt="Stone Marker"
          fill
          sizes="44px"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div ref={timelineRef} id="history" className="relative">
          ...
          >
            ...
            />
            <Image
              src="https://res.cloudinary.com/dxhwcq1eg/image/upload/v1782125492/skt_global_mining/gaadi-jcb.webp"
              alt=""
              aria-hidden="true"
              width={52}
              height={52}
