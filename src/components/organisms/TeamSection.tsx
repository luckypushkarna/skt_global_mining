...
function TeamMemberCard({ member }: { member: typeof TEAM_MEMBERS[0] }) {
  ...
  const images: Record<string, string> = {
    ...
    "d-suresh-babu": "https://res.cloudinary.com/dxhwcq1eg/image/upload/f_auto,q_auto/v1/skt/leaders/suresh-babu-deshamalla.webp",
  ...
  const overlayDetails: Record<string, { title: string; action: string }> = {
    ...
    "d-suresh-babu": { title: "Focusing on Fleet Engineering", action: "Asset Readiness" },
