      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600 leading-relaxed text-[15px]">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">1. Introduction & Scope</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">2. Information We Collect</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">3. Legal Bases and Purpose of Processing</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">4. Data Sharing and Transfer</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">5. Data Retention & Security</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">6. Your Rights</h2>
          ...
          <section className="space-y-3 pb-6 border-b border-neutral-100">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">7. Contact Information</h2>
            <p>
            ...
            <div className="bg-neutral-50 p-6 rounded-xl border border-neutral-200/60 mt-4 space-y-1">
              ...
              <p>Email: <a href="mailto:privacy@sktglobal.com" className="text-rose-600 hover:underline">privacy@sktglobal.com</a></p>
              <p>Registered Office: SKT Tower, BKC, Mumbai 400 051, India</p>
              <p>Zambian Operations: Kitwe, Copperbelt Province, Zambia</p>
            </div>
          </section>
