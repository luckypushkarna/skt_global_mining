      ...
      <div className="max-w-4xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600 leading-relaxed text-[15px]">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">2. Proprietary Rights & Copyright</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">3. Operational Disclaimer & Safety Figures</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">4. Forward-Looking Statements</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">5. Third-Party Links & API Integrations</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">6. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-3 pb-6 border-b border-neutral-100">
            <h2 className="text-xl font-bold text-neutral-900 tracking-tight">7. Governing Law and Jurisdiction</h2>
            <p>
